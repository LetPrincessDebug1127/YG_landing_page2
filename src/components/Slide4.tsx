...
<div className="absolute image-banner:hidden fade-in-section top-0 left-1/2 transform -translate-x-1/2 text-center text-white z-10 desktop-ui:w-[100%] flex flex-col justify-evenly mt-[1%] desktop-md:justify-center desktop-md:gap-[10%] h-full">
  {/* Phần 1 */}
