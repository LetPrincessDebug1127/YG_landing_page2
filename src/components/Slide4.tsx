...
const handleTransitionEnd = () => {
  ...
  return (
    ...
    <div className="absolute image-banner:hidden fade-in-section desktop-ui:w-[100%] mobile-ui:w-[90%] top-0 left-1/2 transform -translate-x-1/2 text-center text-white z-10 mt-[7%] sm+:text-justify">
